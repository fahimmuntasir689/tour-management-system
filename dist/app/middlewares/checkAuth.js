...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!accessToken) {
            throw new AppError_1.AppError(403, 'Token dewa hoy nai');
        }
        console.log('access token paisi....');
        ...
        if (!verifiedToken) {
            throw new AppError_1.AppError(403, 'Token vul dewa hoise or exist e kore na');
        }
        if (!authRoles.includes(verifiedToken.role)) {
            throw new AppError_1.AppError(403, 'tumi user hoye ADMIN er subidha paba na');
        }
